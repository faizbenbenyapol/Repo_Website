    ...
    <div className="rise">
      ...
      <section className="mt-16">
        ...
        <p className="mt-6 max-w-[65ch] text-muted">
          รุ่นนี้คือ v0.2.0 ซึ่งอ่าน repo ได้จริงแล้ว — โคลนซอร์ส สำรวจไฟล์ทั้งหมด
          อ่านโครงสร้างโค้ดด้วย tree-sitter แล้วเชื่อมความสัมพันธ์ระหว่างไฟล์
          ผลออกมาเป็นตัวเลขและตารางก่อน ส่วนกราฟแบบลากซูมได้จะมาในรุ่นถัดไป
