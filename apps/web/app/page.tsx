    ...
    <div className="rise">
      ...
      <section className="mt-16">
        ...
        <p className="mt-6 max-w-[65ch] text-muted">
          รุ่นนี้คือ v0.6.0 ซึ่งถาม–ตอบกับ repo เป็นภาษาไทยได้แล้ว พร้อมเส้นทางอ่านโค้ดสำหรับคนใหม่
          ที่เรียงจากไฟล์พื้นฐานไปจนถึงจุดเริ่มโปรแกรมตามกราฟการพึ่งพาจริง
          ทุกประโยคต้องชี้บรรทัดจริงในโค้ดได้ ข้อไหนชี้ไม่ได้จะไม่ถูกแสดง
          ส่วนที่ใช้โมเดลเปิดให้สมาชิกที่{' '}
          <a className="text-accent underline underline-offset-4" href="/login">
            ล็อกอินแล้วใส่ API key ของตัวเอง
          </a>{' '}
          เพราะค่าเรียกใช้คิดกับกุญแจของผู้ใช้โดยตรง ดูได้ว่าแต่ละรุ่นทำอะไรไปแล้วบ้างที่{' '}
