    ...
    <div className="rise">
      ...
      <section className="mt-16">
        ...
        <p className="mt-6 max-w-[65ch] text-muted">
          รุ่นนี้คือ v0.5.0 ซึ่งเปิดชั้นคำอธิบายภาษาไทยแล้ว — สรุปรายไฟล์ รายโมดูล และภาพรวมทั้ง
          repo โดยทุกประโยคต้องชี้บรรทัดจริงในโค้ดได้ ข้อไหนชี้ไม่ได้จะไม่ถูกแสดง
